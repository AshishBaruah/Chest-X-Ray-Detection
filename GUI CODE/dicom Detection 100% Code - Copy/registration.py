...
frame = tk.LabelFrame(window, text="", width=600, height=600, bd=5, font=('times', 14, ' bold '),bg="#BDD1EE")
frame.grid(row=0, column=0, sticky='nw')
frame.place(x=450, y=150)

lbl = tk.Label(window, text="Registration Form", font=('times', 35,' bold '), height=2, width=55,bg="#BDD1EE",fg="black")
lbl.place(x=0, y=0)
...
l2 = tk.Label(frame, text="Full Name :", width=12, font=("Times new roman", 15, "bold"), bg="#FFFFFF",bd=5)
l2.place(x=30, y=30)
...
l3 = tk.Label(frame, text="Address :", width=12, font=("Times new roman", 15, "bold"), bg="#FFFFFF",bd=5)
l3.place(x=30, y=80)
...
l5 = tk.Label(frame, text="E-mail :", width=12, font=("Times new roman", 15, "bold"), bg="#FFFFFF")
l5.place(x=30, y=130)
t4 = tk.Entry(frame, textvar=Email, width=20, font=('', 15),bd=5)
t4.place(x=230, y=130)
# that is for email address

l6 = tk.Label(frame, text="Phone number :", width=12, font=("Times new roman", 15, "bold"), bg="#FFFFFF")
l6.place(x=30, y=180)
t5 = tk.Entry(frame, textvar=Phoneno, width=20, font=('', 15),bd=5)
t5.place(x=230, y=180)
# phone number
l7 = tk.Label(frame, text="Gender :", width=12, font=("Times new roman", 15, "bold"), bg="#FFFFFF")
l7.place(x=30, y=230)
# gender
tk.Radiobutton(frame, text="Male", padx=5, width=5, bg="#FFFFFF", font=("bold", 15), variable=var, value=1).place(x=230,
                                                                                                                y=230)
tk.Radiobutton(frame, text="Female", padx=20, width=4, bg="#FFFFFF", font=("bold", 15), variable=var, value=2).place(
    x=340, y=230)

l8 = tk.Label(frame, text="Age :", width=12, font=("Times new roman", 15, "bold"), bg="#FFFFFF")
l8.place(x=30, y=280)
t6 = tk.Entry(frame, textvar=age, width=20, font=('', 15),bd=5)
t6.place(x=230, y=280)

l4 = tk.Label(frame, text="User Name :", width=12, font=("Times new roman", 15, "bold"), bg="#FFFFFF")
l4.place(x=30, y=330)
t3 = tk.Entry(frame, textvar=username, width=20, font=('', 15),bd=5)
t3.place(x=230, y=330)

l9 = tk.Label(frame, text="Password :", width=12, font=("Times new roman", 15, "bold"), bg="#FFFFFF")
l9.place(x=30, y=380)
t9 = tk.Entry(frame, textvar=password, width=20, font=('', 15), show="*",bd=5)
t9.place(x=230, y=380)

l10 = tk.Label(frame, text="Confirm Password:", width=13, font=("Times new roman", 15, "bold"), bg="#FFFFFF")
l10.place(x=30, y=430)

t10 = tk.Entry(frame, textvar=password1, width=20, font=('', 15), show="*",bd=5)
t10.place(x=230, y=430)

btn = tk.Button(frame, text="Register", bg="#659CEC",font=("",20),fg="black", width=9, height=1, command=insert)
